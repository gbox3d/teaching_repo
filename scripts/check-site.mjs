...
const EXPECTED_SLIDES = 950;
const EXPECTED = {
  android: { slug: "android", decks: 15, slides: 246, status: "published" },
...
async function main() {
  ...
  check(catalog.site?.stats?.slides === EXPECTED_SLIDES, "site.stats.slides must be 950");
